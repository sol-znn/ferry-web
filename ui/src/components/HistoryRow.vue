...
import {sats, stamp, tokenName} from '@/core/format'
...
const counterparty = computed(
  () => props.swap.zenon?.peerAddress || props.swap.counterpartyPkhHex || '',
)
 ...
 */
const finished = computed(() => props.swap.state === 'redeemed' || props.swap.state === 'refunded')
