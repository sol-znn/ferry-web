...
const {pubKey, btcBound, znnBound, busy, error, load, bindBitcoin, bindZenon, unbind} =
  useBoardIdentity()
  ...
  <section class="grid gap-3 rounded-lg border border-border p-4">
    ...
    <Note summary="What the key and the proofs are each for">
      ...
      <p>
        ...
        both of these for a Bitcoin-against-Zenon trade, Zenon alone for a trade between two Zenon
        tokens. Reading the board needs no proof at all.
      </p>
