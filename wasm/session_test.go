...
func TestResyncCarriesNoSwapValues(t *testing.T) {
	sw := &Swap{
		ID: "00112233445566bb", Network: "regtest", Role: RoleInitiator,
		Out: &Leg{Chain: ChainBTC, Dir: DirOut, Amount: "400000",
			Btc: &BtcLeg{
				Key:      mustKey(t),
		...
		In: &Leg{Chain: ChainZNN, Dir: DirIn, Amount: "10",
			SelfAddr: "z1qqvwzz2xq7q5gwk6uhcddgrpxlfcyzc8rsu82s",
			Znn:      &ZnnLeg{HtlcID: strings.Repeat("ab", 32)}},
	}
